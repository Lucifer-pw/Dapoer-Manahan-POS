            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  if (order.customerName.isNotEmpty) _buildInfoRow('Pelanggan', order.customerName),
                  _buildInfoRow(order.isTakeAway ? 'Tipe' : 'Meja', order.isTakeAway ? 'Dibawa Pulang' : 'Meja ${order.tableNumber}'),
